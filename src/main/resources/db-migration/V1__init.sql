...
CREATE TABLE IF NOT EXISTS MASTERS.ROLES (
    ID SERIAL PRIMARY KEY,
    NAME varchar(255),
    DESCRIPTION TEXT);

CREATE TABLE IF NOT EXISTS MASTERS.USERS (
    ID SERIAL PRIMARY KEY,
    USERNAME VARCHAR (50),
    ...
    CONSTRAINT FK_ROLE_ID_ROLES_ID FOREIGN KEY (ROLE_ID) REFERENCES MASTERS.ROLES(ID));
